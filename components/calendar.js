...
export default function Cal_Block(props){
    ...
    var months_years = [];
    for (var i = 1; i <= 12; i++) { // build array of month integers to use to render the Calendar Components
...
function Calendar(props){   // each month is a Calendar component
            ...
            <div >
                ...
                <div className={styles.days_container}>
                  ...
                  { days.map((day) => // day is a date object
                        ...
                        day={day}
                        key={day.toString()}
                        selected={ (day >= props.first_date && day <=props.last_date)  ? true : false} // true or false, , used to assign selected class
    ...
    function check_booked(booked_dates,day){  //check if that day is booked already
    ...
    function daysInMonth(month,year) {  //helper function for building days in month array
    ...
    function firstDayOfMonth(month, year) {//helper function to find day of week of first day of month
...
function Day_box(props) {  // Component for each day
    return(
        <>
